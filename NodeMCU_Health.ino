...
const char* ssid = "CASA 11";

//Senha da rede
const char* password = "lilo2016";
...
void loop() {
  ...
  buf += "<title>AAS Home Control</title> ";
  buf += "<style> ";
  ...
  buf += "<p align='center'><font size='10'>Controle de Devices</font></p> ";
  buf += "</div> ";
  buf += "</div> ";
  buf += "<div class='row'> ";
  ...
  buf += "</div> ";
  buf += "<div class='col twelve'> ";
  buf += "<p align='center'><font size='5'>AAS Home System</font></p> ";
  buf += "</div> ";
  buf += "</div> ";
  buf += "</body> ";
  buf += "</html> ";
